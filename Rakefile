...
namespace :db do
  ...
  task :create do
    ...
    system("createdb -U postgres #{APP_NAME}_development && createdb -U postgres #{APP_NAME}_test")
  end
  ...
  task :drop do
    ...
    system("dropdb -U postgres #{APP_NAME}_development && dropdb -U postgres #{APP_NAME}_test")
  end
